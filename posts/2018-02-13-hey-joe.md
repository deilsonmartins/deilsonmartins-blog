...
![Computer](/assets/images/profile.jpg)
...
export default function HeaderBar({HiddenHeader}) {
  return (
    
    <HeaderWrapper HiddenHeader={HiddenHeader}>
        <Profile HiddenHeader={HiddenHeader}/>
        <SocialLinks/>
        <MenuLinks HiddenHeader={HiddenHeader}/>
    </HeaderWrapper>
  );
}
